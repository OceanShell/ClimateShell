...
uses
  Classes, SysUtils, Process, ncmain, declarations_netcdf;
...
begin
 ...
 {$endif}
  ...
  AboutOpts:=[poUsePipes, poWaitOnExit, poStderrToOutPut, poNoConsole];
    ...
    Result:='asnc netCDF reader ('+winver+')'+LineEnding+LineEnding+
   ...
   Result:=Result+LineEnding+'© 2009-2019 by Alexander Smirnov';
end;
